...
namespace RoomieFinderInfrastructure.Migrations
{
    ...
    [Migration("20240625113827_initMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RoomieFinderInfrastructure.Models.Questionnaire", b =>
                {
                    ...
                    b.Property<int>("UniversityId")
                        .HasColumnType("int")
                        .HasComment("Foreign key referencing table university");
            ...
            modelBuilder.Entity("RoomieFinderInfrastructure.Models.University", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("The unique identifyer of each university");
                    ...
                    b.Property<string>("Name")
                        ...
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)")
                        .HasComment("The name of the university");

                    b.HasKey("Id");

                    b.ToTable("Universities", t =>
                        {
                            t.HasComment("The university is where students go to study");
                        });
                });

            modelBuilder.Entity("RoomieFinderInfrastructure.Models.UniversityAdmin", b =>
                {
                    b.Property<int>("UniversityAdminId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasComment("The unique identifyer for each university admin");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("UniversityAdminId"));
                    ...
                    b.ToTable("UniversityAdmins", t =>
                        {
                            t.HasComment("The users who is responsible for the tests and matching roomates");
                        });
                });
            ...
            modelBuilder.Entity("RoomieFinderInfrastructure.Models.Dormitory", b =>
                {
                    b.HasOne("RoomieFinderInfrastructure.Models.University", null)
            ...
            modelBuilder.Entity("RoomieFinderInfrastructure.Models.Questionnaire", b =>
                {
                    b.HasOne("RoomieFinderInfrastructure.Models.University", "University")
                        .WithMany()
                        .HasForeignKey("UniversityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RoomieFinderInfrastructure.Models.UniversityAdmin", b =>
                {
                    b.HasOne("RoomieFinderInfrastructure.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("UniversityAdmin")
                        .HasForeignKey("RoomieFinderInfrastructure.Models.UniversityAdmin", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
